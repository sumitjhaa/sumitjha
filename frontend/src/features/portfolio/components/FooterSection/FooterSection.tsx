        ...
        <SectionShell id="footer">
            <div className={styles.anchor}>
                ...
                <div className={styles.bottom}>
                    <h2 className={styles.outline}>Connect</h2>
                        ...
                        `}</style>
                            <g transform="translate(6, 8)">
                                <g transform="rotate(-15, 7, 10) translate(0, 1)">
                                    <path
                                        className="footer-ear-left-sleep"
                                ...
                                <g transform="rotate(15, 19, 10) translate(0, 1)">
                                    <path
                                        className="footer-ear-right-sleep"
                            ...
                            >
                                <g
                                    strokeWidth="1.5"
                                    style={{
                                        animation: 'zFloat1 3s ease-out 0s infinite normal both',
                                    }}
                                >
                                ...
                                <g
                                    strokeWidth="1.3"
                                    style={{
                                        animation: 'zFloat2 3s ease-out 1s infinite normal both',
                                    }}
                                >
                                ...
                                <g
                                    strokeWidth="1.1"
                                    style={{
                                        animation: 'zFloat3 3s ease-out 2s infinite normal both',
                                    }}
                                >
