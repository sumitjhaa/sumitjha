...
export const PROJECTS: Project[] = [
    ...
    },
    {
        ...
        title: 'Freddit',
        description:
            'A feature-rich Reddit clone built with Ruby on Rails and PostgreSQL. Users can create communities, post content, upvote and downvote, leave threaded comments, and build discussion spaces around any topic. Full authentication, moderation tools, and a clean responsive interface make it feel right at home.',
        ...
        links: [{ label: 'GitHub', url: 'https://github.com/sumitjhaa/freddit' }],
        date: '2025-04-12',
        status: 'Completed',
    },
    {
        ...
        title: 'Vigilante',
        description:
            'A pipeline-based malware detection system that combines machine learning with fast feature extraction for real-time threat scanning. The Python backend uses Pandas and NumPy for data processing and Scikit-learn for classification, served through a Flask API. Extract PE file features, run predictions, and get results in milliseconds.',
        ...
        links: [{ label: 'GitHub', url: 'https://github.com/sumitjhaa/Malware-detector-ML' }],
        date: '2025-03-10',
        status: 'Completed',
    },
    {
    ...
    },
    {
        ...
        title: 'Dragnotes',
        description:
            'A privacy-first sticky notes app that respects your anonymity — no accounts, no tracking, just pure drag-and-drop note-taking. Built with React and Sass for a polished UI, backed by a Node.js server for optional sync. Create, organize, and toss notes with zero friction.',
    ...
    },
    {
        ...
        title: 'Tugnotes',
        description:
            'A lightweight Kanban board for simple drag & drop task management. No frameworks, no bloat — just vanilla HTML, CSS, and JavaScript. Create tasks, move them across columns, and keep your workflow visual and minimal. Perfect for when you just need to get things done.',
    ...
    },
    {
        ...
        title: 'Otakudoro',
        description:
            'An anime-themed Pomodoro timer that brings your favourite aesthetic to productivity. Built with Electron for cross-platform support on Windows and Linux, featuring custom themes, focus sessions, break timers, and a clean interface. Stay focused in style — your waifu would be proud.',
    ...
    },
    {
        ...
        title: 'Ziggle',
        description:
            'Physics animation project showcasing smooth motion and dynamic visual effects.',
